...
if __name__ == '__main__':
	...
	p1 = multiprocessing.Process(target=server_program, args=(shared_dict,count1,count2,q1,q2,r1,r2,rq1,rq2,req,di,dli,8000))
	p2 = multiprocessing.Process(target=intraserver, args=(8001,q1,shared_dict,count1,f1,r1,rq1,di,dli,req))
	p3 = multiprocessing.Process(target=intraserver, args=(8002,q2,shared_dict,count2,f2,r2,rq2,di,dli,req))
	p4 = multiprocessing.Process(target=intraclient, args=(6002,q1,shared_dict))
	p5 = multiprocessing.Process(target=intraclient, args=(7001,q2,shared_dict))
